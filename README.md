...
```text
[ BUILD ]  software products with real users
[ TEST  ]  AI reliability and abstention behavior
[ MODEL ]  aerospace systems (UAV, CFD, controls)
...
**Areas of Interest:** `AI` · `Aerospace` · `Autonomy` · `CAD` · `Simulation` · `Software` · `Research`

[![Portfolio](https://img.shields.io/badge/🌐_Visit_My_Portfolio-FF6B6B?style=for-the-badge)](https://suhaslord.github.io/portfolio/)
[![LinkedIn](https://img.shields.io/badge/💼_Connect_on_LinkedIn-0A66C2?style=for-the-badge)](https://www.linkedin.com/in/suhas-beemineni-1984763b8/)
